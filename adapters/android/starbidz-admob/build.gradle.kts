    ...
    publishing {
        publications {
            create<MavenPublication>("release") {
                ...
                artifactId = "starbidz-admob"
                version = project.property("STARBIDZ_VERSION").toString()

                pom {
                    name.set("Starbidz AdMob Adapter")
                    description.set("Google AdMob adapter for Starbidz SDK")
